...
from transformers import AdamW, RobertaTokenizer, get_linear_schedule_with_warmup,AutoTokenizer, AutoModel
...
if __name__ == "__main__":
    ...
    tokenizer = AutoTokenizer.from_pretrained("", add_prefix_space=True)
    print("loading data...")
